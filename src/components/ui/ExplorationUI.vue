<template>
  <transition name="dialogue-fade">
    <div v-if="displayStore.isDialogueVisible" class="dialogue-box-wrapper" @click="handleBoxClick">
      <div class="dialogue-box">
        ...
        <div class="choice-container">
          <transition-group name="dialogue-fade">
...
import { selectChoice } from '@/services/runOrchestrator';
